...
public class cashierInterfaceIntegrated {
    ...
    public static void main(String args[]) {
        ...
        mainPanel2 = new JPanel(panelSwitcher); //mainPanel2 will now host all the different panels
...
//        mainPanel.add(testItemButton, BorderLayout.CENTER);
        ...
        cashierDashboard.add(mainPanel2, BorderLayout.CENTER);
    ...
    private static void showSpecificDrinks(String drinkType) {
        ...
        selectPanel.repaint();
        panelSwitcher.show(mainPanel2, "Specific Drink Selection");
    }
    ...
    private static void showCustomizeDrink(String drink) {
        ...
        confirmButton.addActionListener(e -> {
            ...
            panelSwitcher.show(mainPanel2, "General Drinks");
        });
        gbc.gridx = 0;
        gbc.gridy++;
        ...
        panelSwitcher.show(mainPanel2, "Customize Drink");
    }

    private static void addBackButton(JPanel panel, String previousPanel) {
        JButton backButton = new JButton("Back");
        backButton.addActionListener(e -> panelSwitcher.show(mainPanel2, previousPanel));
        GridBagConstraints gbc = new GridBagConstraints();
        gbc.gridx = 1;
